...
const ROOT_URL = "http://52.9.107.69:3001";
...
export const submitOwnerSignUp = values => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.post(`${ROOT_URL}/signup`, values);
  /* .then(res  => { */
  console.log(res);
  if (res.status === 200) {
    dispatch({
...
export const submitProperty = values => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.post(`${ROOT_URL}/addProperty`, values);
  /*     .then(res  => {
      console.log( res );  */
  if (res.status === 200) {
    dispatch({
...
export const updateProfile = values => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.post(`${ROOT_URL}/updateprofile`, values);
  /* .then(res  => { */
...
export const searchProperties = values => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.post(`${ROOT_URL}/searchevents`, values);
  /* .then(res  => { */
...
export const fetchpropertydetails = values => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.get(`${ROOT_URL}/fetcheventdetails/` + values);
  /* .then(res  => { */
  console.log("res status" + res.status);
  if (res.status === 200) {
    dispatch({
...
export const travelerpropertydetails = values => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.post(`${ROOT_URL}/download`, values);
  /* .then(res  => { */
  console.log("res status" + res.status);
  if (res.status === 200) {
    dispatch({
...
export const getmytrips = () => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.get(`${ROOT_URL}/getmytrips`);
  /* .then(res  => { */
  console.log("res status" + res.status);
  if (res.status === 200) {
    dispatch({
...
export const getownerdashboard = () => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.get(`${ROOT_URL}/getownerdashboard`);
  /* .then(res  => { */
  console.log("res status" + res.status);
  if (res.status === 200) {
    dispatch({
...
export const travelerSendMessage = values => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.post(`${ROOT_URL}/sendmessage`, values);
  /* .then(res  => { */
  console.log("res status" + res.status);
  if (res.status === 200) {
    dispatch({
...
export const fetchmessagelist = () => async dispatch => {
  console.log("Inside traveler send message");
  axios.defaults.withCredentials = true;
  const res = await axios.get(`${ROOT_URL}/getmessagelist`);
  /* .then(res  => { */
  console.log("res status" + res.status);
  if (res.status === 200) {
    dispatch({
...
export const fetchmessagethreaddetails = values => async dispatch => {
  ...
  axios.defaults.withCredentials = true;
  const res = await axios.get(`${ROOT_URL}/getmessagethread/` + values);
  /* .then(res  => { */
  console.log("res status" + res.status);
  if (res.status === 200) {
    dispatch({
...
export const postEvent = values => async dispatch => {
  console.log("inside submit profile");
  axios.defaults.withCredentials = true;
  const res = await axios.post(`${ROOT_URL}/postevent`, values);
  /* .then(res  => { */
  console.log("res profile" + res.status);
  console.log(res);
  if (res.status === 200) {
