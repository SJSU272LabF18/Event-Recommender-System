...
import { submitTravelerLogin } from "../../actions";
...
/*     if (nextProps.newPost) {
  ...
  renderField(field) {
    ...
    onSubmit(values) {
        console.log(values);
        this.props.submitTravelerLogin(values, () => {
    ...
    render(){  
        ...
        return(
            ...
            Need an account?     
            <Link to="/travelersignup">Sign Up</Link>
            </div>
...
function validate(values) {
  ...
  const mapStateToProps = state => ({
    authFlag: state.loginreducer.travelerauthFlag
  });
  ...
  })(connect(mapStateToProps, { submitTravelerLogin })(OwnerLogin));
