...
class HomePage extends Component {
  ...
  searchResultsHandler = async e => {
    ...
    /*         axios.post('http://52.9.107.69:3001/searchproperties',data)
            .then(response => {
  ...
  handlerListProperties = e => {
    ...
    /* axios.get('http://52.9.107.69:3001/getusertype/'+ emailid)
            .then(response => {
        ...
        <div className="container marketing">
          <div className="row">
            <div className="col-lg-4">
              ...
              <p>
                In the mood for hosting a party, talk show, workshop, concert,
                or any event? We got it all covered for you! "Evento" provides
                an excellent platform to host events. To top it up, we provide
                you with an estimate of the attendance for the event which can
                help you plan much better! Go ahead and try our unique feature.
              </p>
              <p>
                <Link
                  to="/hostevent"
            ...
            <div className="col-lg-4">
              ...
              <p>
                Dive in for an ultimate experience of events specially
                handpicked for you. Through our efficient learning algorithm, we
                have come up with a method to recommend the best of the best
                events satisfying all your information.
              </p>
              <p>
                <Link
                  to="/eventrecommendation"
                  className="btn btn-default"
                  href="#"
                  role="button"
                >
            ...
            <div className="col-lg-4">
              ...
              <h2>Search Events</h2>
              <p>
                Attending an event is an opportunity to meet new people,
                network, improve business opportunities, and have fun. Do more
                of what you love! Adventure is just a click away. Explore the
                endless opportunities that MeetUp can offer you.
              </p>
              <p>
                <Link
                  to="/searchevent"
          ...
          <div className="row featurette">
            <div className="col-md-7">
              ...
              <p className="lead">
                If you are thinking of hosting an event, let Evento predict the
                number of users interested in your event, so that you can plan
                your event better. Evento uses Machine Learning to do the
                prediction. Just enter the details of the event you are thinking
                of hosting and click on "Predict"
              </p>
            </div>
          ...
          <div className="row featurette">
            <div className="col-md-7 col-md-push-5">
              ...
              <p className="lead">
                Based on the kind of events you usually like to attend, our
                recommendation engine suggests upcoming events for you, that fit
                your taste
              </p>
            </div>
          ...
          <div className="row featurette">
            <div className="col-md-7">
              <h2 className="featurette-heading">
                And lastly, search events. <span className="text-muted" />
              </h2>
              <p className="lead">
                The good old Search bar allows you to search events taking place
                around you
              </p>
            </div>
            <div className="col-md-5">
