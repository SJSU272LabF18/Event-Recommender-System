          ...
          <div className="container col-lg-9">
            <div className="location-form">
              <div class="checklist-header-container ">
                <h4>
                  <span>Add upto 5 photos of your property</span>
                </h4>
                <hr />
              </div>
              <form onSubmit={this.onSubmit}>
                <div class="photos-drop-inside">
                  ...
                  <h2 class="photo-drop-error text-muted">
                    Only JPEG images are supported
                  </h2>
                  <div class="photo-drop-info small text-muted">
                    0 of 50 uploaded. 6 are required. You can choose to upload
